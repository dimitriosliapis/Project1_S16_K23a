...
* __Bidirectional Breadth-First-Search__
    ...
    * `bBFS()`
    ...
    _Σημείωση: Σε στατικού γράφου, ανάλογα με με το αποτέλεσμα της `isReachableGrailIndex()`, στην περίπτωση ΥΕΣ η αναζήτηση περιορίζεται σε ένα SCC, ενώ στην περίπτωση ΜΑΥΒΕ, για κάθε επίπεδο που επεκτείνεται ξανακαλείται η `isReachableGrailIndex()` και πράττει αναλόγως.
