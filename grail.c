...
GrailIndex* buildGrailIndex(ind *index_out, list_node *buffer_out, ind *index_in, list_node *buffer_in, SCC* scc, ht_Node *explored, ht_Node *explored_twice, uint32_t version){
